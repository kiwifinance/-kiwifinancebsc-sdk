...
const Icon: React.FC<SvgProps> = (props) => {
  ...
  return (
    ...
    <defs>
      <mask id="mask" x="3.75" y="3.75" width="64.5" height="74.24" maskUnits="userSpaceOnUse">
          <path d="M68.25,36A32.25,32.25,0,1,1,36,3.75,32.25,32.25,0,0,1,68.25,36Z" fill="#c4c4c4"/>
      </mask>
    </defs>
    <path d="M72,36A36,36,0,1,1,36,0,36,36,0,0,1,72,36Z" fill="#e9eaeb"/>
        <path d="M35,19.73v-.52a3.58,3.58,0,0,1,.44-1.84,7.14,7.14,0,0,1,1.24-1.46A13.12,13.12,0,0,1,38,14.72a6,6,0,0,0,1.12-1,2,2,0,0,0,.44-1.3,1.58,1.58,0,0,0-.77-1.51,4.94,4.94,0,0,0-2.5-.47,8.94,8.94,0,0,0-2.29.3,8.2,8.2,0,0,0-1.92.72V7.7a10.63,10.63,0,0,1,2.39-.79,14,14,0,0,1,3.06-.31A7.39,7.39,0,0,1,42.44,8a4.63,4.63,0,0,1,1.68,3.8,4.42,4.42,0,0,1-.64,2.5,9.29,9.29,0,0,1-1.84,1.93l-1.71,1.48a2.09,2.09,0,0,0-.68,1.65v.36Zm-.19,4.88v-3.2h4.65v3.2Z" fill="#bdc2c4"/>
          <path d="M57.52,33.42h-41a27.59,27.59,0,0,0-1.91,3.66A31.33,31.33,0,0,0,12,49.62C12,65.29,23.19,78,37,78s25-12.7,25-28.37a31.33,31.33,0,0,0-2.57-12.54A27.59,27.59,0,0,0,57.52,33.42Z" fill="#875930"/>
          <path d="M58.06,34.77a2.3,2.3,0,0,1-.3,1.13C56.08,39.1,47.43,41.53,37,41.53S17.92,39.1,16.24,35.9a2.3,2.3,0,0,1-.3-1.13c0-1.22,1-2.37,2.78-3.36C22.35,29.38,29.18,28,37,28s14.65,1.37,18.28,3.4C57.05,32.4,58.06,33.55,58.06,34.77Z" fill="#80cc33"/>
          <path d="M48.52,34.17c0,1.55-5,2.81-11.24,2.81S26,35.72,26,34.17s5-2.81,11.24-2.81S48.52,32.62,48.52,34.17Z" fill="#dbe6b7"/>
            <path d="M25.51,34.57c0,.36-.64.66-1.42.66s-1.42-.3-1.42-.66.64-.67,1.42-.67S25.51,34.2,25.51,34.57Z" fill="#010100"/>
            <ellipse cx="49.6" cy="34.73" rx="1.48" ry="0.7" fill="#010100"/>
            <path d="M28.58,36.4c0,.38-.66.7-1.48.7s-1.48-.32-1.48-.7.66-.7,1.48-.7S28.58,36,28.58,36.4Z" fill="#010100"/>
            <path d="M35.88,37.68c0,.59-1,1.06-2.24,1.06s-2.25-.47-2.25-1.06,1-1,2.25-1S35.88,37.1,35.88,37.68Z" fill="#010100"/>
            <path d="M46.69,37.56c0,.42-.71.76-1.6.76s-1.6-.34-1.6-.76.71-.75,1.6-.75S46.69,37.15,46.69,37.56Z" fill="#010100"/>
            <path d="M27.49,32.21c0-.48-.83-.87-1.86-.87s-1.86.39-1.86.87.84.88,1.86.88S27.49,32.7,27.49,32.21Z" fill="#010100"/>
            <path d="M35.11,30.83c0-.48-.84-.87-1.86-.87s-1.86.39-1.86.87.83.88,1.86.88S35.11,31.32,35.11,30.83Z" fill="#010100"/>
            <path d="M48,31.75c0-.51-.87-.92-1.94-.92s-1.95.41-1.95.92.87.91,1.95.91S48,32.25,48,31.75Z" fill="#010100"/>
          <ellipse cx="30.4" cy="55.69" rx="5.91" ry="7.88" fill="#fff"/>
          <ellipse cx="43.98" cy="55.69" rx="5.91" ry="7.88" fill="#fff"/>
          <path d="M38.6,62.88a.3.3,0,0,0-.54.07,2.82,2.82,0,0,0-.07.82,2.67,2.67,0,0,1-.16.69,1.06,1.06,0,0,1-.68.69c-.95.23-1-1.63-1-2.12,0-.24-.39-.32-.44-.06-.17,1,0,2.82,1.44,2.83a1.53,1.53,0,0,0,1.2-.76A2.52,2.52,0,0,0,38.6,62.88Z" fill="#592d0f"/>
          <path d="M30.17,45c-1.17-1-2.87.22-3.53,1.24-.11.17.15.37.28.22a4.54,4.54,0,0,1,1.27-1,3.6,3.6,0,0,1,1.87-.21A.15.15,0,0,0,30.17,45Z" fill="#592d0f"/>
          <path d="M44.86,46.11c-.81-1.91-3.33-1.28-4.58-.29-.12.1,0,.28.17.21a5,5,0,0,1,2.09-.63,3.23,3.23,0,0,1,2.11.92C44.79,46.42,44.91,46.23,44.86,46.11Z" fill="#592d0f"/>
