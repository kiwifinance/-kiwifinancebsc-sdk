...
export const Connected: React.FC = () => {
  return (
    <BrowserRouter>
      <Menu
        account="0xCfDf8A80fECAeeCC144fa74c0Df8691BFd0e26e3"
        login={noop}
        logout={noop}
        isDark={false}
        toggleTheme={noop}
...
export const WithProfile: React.FC = () => {
  return (
    <BrowserRouter>
      <Menu
        account="0x28db020a1c976167cde0d2b78221ed4659d9ec0a"
        login={noop}
        logout={noop}
        isDark={false}
        toggleTheme={noop}
        ...
        profile={{
          username: "kiwiswap",
          image: "https://kiwiswap.finance/images/nfts/blueberries-preview.png",
          profileLink: "/profile",
          noProfileLink: "/no-profile",
        }}
      >
